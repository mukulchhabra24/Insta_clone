...
import com.example.insta_clone.loginActivity;
...
public class ComposeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        takePic=view.findViewById(R.id.btnTakePic);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(desc.isEmpty())
                {
                    Toast.makeText(getContext(), "Cannot make post without description", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void launchCamera() {
        ...
        Uri fileProvider = FileProvider.getUriForFile(getContext(), "com.codepath.fileprovider.Insta_clone", photoFile);
